...
#else
                new SysApp{Id=142307070898245, Name="平台管理", Code="system", Active="Y", Status=0, Sort=100 },
                new SysApp{Id=142307070902341, Name="系统管理", Code="manage", Active="N", Status=0, Sort=200 },
                new SysApp{Id=142307070922869, Name="业务应用", Code="busiapp", Active="N", Status=0, Sort=300 },
                #endif
            };
        }
    }
