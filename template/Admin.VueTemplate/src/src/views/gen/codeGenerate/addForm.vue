  ...
  >
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-row :gutter="24">
          <a-col :md="12" :sm="24">
            <a-form-item label="前端项目" :labelCol="labelCol" :wrapperCol="wrapperCol" has-feedback>
              <a-input
                placeholder="请输入前端项目名"
                v-decorator="['frontProject', { rules: [{ required: true, message: '请输入前端项目名！' }] }]"
              />
            </a-form-item>
          </a-col>
          <a-col :md="12" :sm="24">
  ...
  methods: {
    ...
    selectedByDefault() {
      this.form.getFieldDecorator('nameSpace', {
        initialValue: 'Admin.VueApp.Application'
      })
      this.form.getFieldDecorator('frontProject', {
    ...
    generateTypeRadio(generateType) {
      ...
      //   this.form.setFieldsValue({ nameSpace: 'Admin.VueApp.Application' })
      // }
    }
  }
}
