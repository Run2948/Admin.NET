      ...
      <a-row :gutter="24">
        <a-col :md="24" :sm="24">
          <a-form-item label="附属信息:" :labelCol="labelCol_JG" :wrapperCol="wrapperCol_JG">
            <a-table size="middle" :columns="columns" :dataSource="data" :pagination="false" :loading="memberLoading">
    ...
    getUserDetaile(id) {
      sysUserDetail({ id: id }).then(res => {
        ...
        this.form.getFieldDecorator('sysEmpParam.orgName', {
          initialValue: SysEmpInfo.orgName
        })
        this.form.getFieldDecorator('sysEmpParam.posIdList', {
          initialValue: Positions
        })
        this.form.getFieldDecorator('sysEmpParam.jobNum', {
          initialValue: SysEmpInfo.jobNum
        })
        this.form.getFieldDecorator('sysEmpParam.orgId', {
          initialValue: SysEmpInfo.orgId
        })
