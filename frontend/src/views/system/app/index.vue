      ...
      <a-spin :spinning="loading">
        ...
        >
          <template slot="operator" v-if="hasPerm('sysApp:add')">
            <a-button @click="$refs.addForm.add()" icon="plus" type="primary" v-if="hasPerm('sysApp:add')"
              >新增应用</a-button
            >
          </template>
          ...
          <span slot="status" slot-scope="text, record">
            <a-popconfirm
              ...
              @confirm="() => editAppStatus(text, record)"
            >
...
import { getAppPage, sysAppDelete, sysAppSetAsDefault, sysAppChangeStatus } from '@/api/modular/system/appManage'
