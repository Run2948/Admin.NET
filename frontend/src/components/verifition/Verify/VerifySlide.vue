<template>
  <div style="position: relative">
    <div :style="{ height: parseInt(setSize.imgHeight) + vSpace + 'px' }" class="verify-img-out" v-if="type === '2'">
      <div :style="{ width: setSize.imgWidth, height: setSize.imgHeight }" class="verify-img-panel">
        <img :src="'data:image/png;base64,' + backImgBase" alt="" style="width: 100%; height: 100%; display: block" />
        <div @click="refresh" class="verify-refresh" v-show="showRefresh"><i class="iconfont icon-refresh"></i></div>
